...
function pmb_resize_an_image_inside(element){
    ...
    if(typeof(figure_caption) !== 'undefined'){
        ...
        caption_height = caption_box.marginTop + caption_box.h + caption_box.marginBottom;
    }
    ...
    if(typeof(figure_image) !== 'undefined') {
        ...
        var max_height_because_of_max_width = page_box.w * figure_image_box.h / figure_image_box.w + caption_height;
